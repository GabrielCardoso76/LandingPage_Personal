  ...
  return (
    <section className="info-blocks-section">
      ...
      <div className="info-block dedication-block scroll-animate slide-right">
        <img src={logo} alt="Logo" className="logo" style={{ marginBottom: '20px', width: '100px' }} />
        <h2>Seu Treino na Palma da Mão</h2>
        <p>
          Mais que um personal trainer, sou um arquiteto de transformações. Com anos de experiência internacional e uma metodologia baseada em dados precisos, desenvolvo estratégias personalizadas que transcendem os limites convencionais do fitness. Minha filosofia combina ciência, tecnologia e dedicação absoluta para entregar resultados mensuráveis e duradouros, independentemente de onde você esteja no mundo.
        </p>
        <p>
          <strong>Metodologia Inovadora:</strong> Minha abordagem vai além do convencional. Eu integro tecnologia de ponta para monitorar seu progresso em tempo real, permitindo ajustes precisos e um plano de treino dinâmico que evolui com você. Cada exercício, cada série e cada repetição são pensados para maximizar seus resultados de forma segura e eficiente.
        </p>
        <p>
