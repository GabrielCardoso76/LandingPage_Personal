  ...
  return (
    <section className="info-blocks-section">
      <div className="info-block">
        <h2><ScrollReveal>Seu Treino na Palma da Mão</ScrollReveal></h2>
      ...
      <div className="info-block dedication-block">
        <h2><ScrollReveal>10 Anos de Dedicação</ScrollReveal></h2>
